                    ...
                    <div className="item-form__availability">
                        ...
                        <div className="item-form__status">
                            <div className="item-form__status-subcontainer">
                                <input className="item-form__status-subcontainer-option" type="radio" value="In Stock" name="stockStatus" />
                                <p className="item-form__status-subcontainer-text">In stock</p>
                            </div>
                            <div className="item-form__status-subcontainer">
                                <input className="item-form__status-subcontainer-option" type="radio" value="Out of Stock" name="stockStatus" />
